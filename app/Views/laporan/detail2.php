                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            ...
                            <?php foreach ($result as $value) : ?>
                                ...
                                <p class="card-text">Total Biaya : <?= number_to_currency($value['Total_Biaya'], 'IDR', 'id_ID', 2) ?></p>
                                <p class="card-text">Tarif Denda : <?= number_to_currency($value['Tarif_Denda'], 'IDR', 'id_ID', 2) ?></p>
                                <p class="card-text">Waktu Keterlambatan : <?= $value['Waktu_Keterlambatan'] ?> Hari</p>
                                <p class="card-text">Tarif Kerusakan : <?= number_to_currency($value['Tarif_Kerusakan'], 'IDR', 'id_ID', 2) ?></p>
